...
<body>
	...
	<form method="POST">
		...
		<br> 
		<label> Pays </label><input class="pseudo" id="pseudo" type="text" placeholder=" France " name="pays" required="" pattern="([A-Z]+[A-Z]?\-)?[0-9]{1,2} ?[0-9]{3}">
		<br>
		
		<br> 
		<label> Ville </label><input class="pseudo" id="pseudo" type="text" placeholder=" ville " name="ville" required="" pattern="([A-Z]+[A-Z]?\-)?[0-9]{1,2} ?[0-9]{3}">
		<br>

 ...
 <section id="service" align="center">
     <div class="container">
            ...
            <div class="row text-center"> 
                    ...
                    <h4 class="service-heading">Vous êtes connecté sous le profil : Professionnel</h4>
                    <p class="text-muted">Voulez vous consulter votre profil ou des offres de stage ou vous deconnecter ?</p>
                    <br>
                    <br>
						...
						<?php echo anchor('/main_stage/afficher_offres_pro','Gestion des offres de stage', 'class="btn_choice" name="offre"' ); ?>

                        <?php echo anchor('/main_stage/edit_entreprise_pro','modifier les informations de votre entreprise', 'class="btn_choice" name="deconnecter"' )?>
                        <br>
                        <br>
                        <br>
                        <!-- <a href="#" class="btn_choice" name="offre" >Gestion des offres de stage</a> -->

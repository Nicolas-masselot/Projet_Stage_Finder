 ...
 <section id="service" align="center">
     <div class="container">
            ...
            <div class="row text-center"> 
                    ...
                    <h4 class="service-heading">Vous êtes connecté sous le profil : Administrateur</h4>
                    <p class="text-muted">Voulez vous consulter votre profil, des offres de stage, valider un stage, gerer les utilisateurs et les conventions, vous deconnecter ou encore acceder a la gestion des contenus ?</p>
                    <br>
                    <br>
                    <br>
                       ...
                       <!-- <a href="#" class="btn_choice" name="stage" >Gestion des offres de stages</a> -->
                        </br>
                        </br>
                        </br>
                        <!-- ajouter formulaire pour les entreprises -->
						<?php echo anchor('/main_stage/afficher_utilisateurs','Gérer les utilisateurs', 'class="btn_choice" name="gestionutilisateur"' ); ?>
                        <!-- <a href="#" class="btn_choice" name="gestionutilisateur" >Gerer les utilisateurs</a> -->
						...
						<?php echo anchor('/main_stage/afficher_offres_valide','Editer une convention', 'class="btn_choice" name="editionconv"' ); ?>
                        <!-- <a href="#" class="btn_choice" name="editionconv" >Editer une convention</a> -->

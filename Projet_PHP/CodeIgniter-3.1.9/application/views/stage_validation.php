...
<div>
<?php echo anchor('/main_stage/afficher_demandes_validation','Retour ', 'class="btn_choice" ' ); ?>
</div> 
...
<body id="page-top" class="index">
    ...
    <section id="service" align="center">
     <div class="container">
            ...
            <div class="row text-center"> 
					...
					<p style="font-size:160%;"><?php echo $stage->tel_ent;?></p>
                    <br>
                    <br>
                    <label>Mail de l'entreprise</label>
					<p style="font-size:160%;"><?php echo $stage->mail_ent;?></p>
                    <br>
                    <br>    
                   ...
                   <label>Demandeur</label>
                    <p style="font-size:160%;"><?php echo $stage->demandeur;?></p>
                    <br>
                    <br>   
    ...
    <section id="about" class="bg-light-gray">
        <div class="row text-center"> 
                    ...
                    <br>
                    <h7> Valider le stage </h7>
                    <br>
                    <br>
                     
                    <?php echo anchor("/main_stage/afficher_confirmation_validation/$stage->id_stage",'Cliquez ici', 'class="btn_choice" ' ); ?>
                         <br>
                         <br>
                         <br>

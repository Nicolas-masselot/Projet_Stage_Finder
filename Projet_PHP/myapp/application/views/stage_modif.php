...
<body>
	...
	<form method="POST" >
		...
		<br>
			<?php 
				if ($validation) {
					echo '<center><input type="submit" id="button" value="Modifier les valeurs">';
					echo anchor("/main_stage/afficher_confirmation_suppression_stage/$stage->id_stage",'Supprimer', 'class="btn_choice" ' );
					echo '</center>';
				} else {
					echo '<h3>Ce stage a été validé</h3>';
				}
			?>

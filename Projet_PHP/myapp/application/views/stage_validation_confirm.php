...
<body id="page-top" class="index">
    ...
    <section id="about" class="bg-light-gray">
        <div class="row text-center"> 
                    ...
                    <br>
                    <h7> Confirmer validation ? </h7>
                    <br>
                    <br>
                     
                     <div>
                        <?php echo anchor("/main_stage/valider_offre/$stage->id_stage",'Oui', 'class="btn_choice" ' ); ?>
                        <?php echo anchor("/main_stage/afficher_demande/$stage->id_stage",'Non ', 'class="btn_choice" ' ); ?>
                    </div>

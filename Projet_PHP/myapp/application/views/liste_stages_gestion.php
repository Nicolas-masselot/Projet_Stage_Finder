...
<body id="page-top" class="index">
    ...
    <section id="service" align="center">
     <div class="container">
			...
			<td>
				<?php echo anchor("/main_stage/modifier_stage/$offre->id_stage", 'Voir offre', 'class="btn btn-info"' );?>
	...
	<section id="about" class="bg-light-gray">
        <div class="row text-center"> 
                    ...
                    <h7> Ajouter un Stage </h7>
                    <br>
                    <br>
                     
					 <?php echo anchor('/main_stage/creer_stage','Cliquer ici', 'class="btn_choice" ' ); ?>

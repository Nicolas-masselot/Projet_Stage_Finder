...
<body>
	...
	<form method="POST">
		...
		<label> Nom Entreprise</label><input class="pseudo" id="pseudo" type="text" placeholder=" StageFinderAndCo " name="nom" required="" value="<?php echo set_value('nom',$entreprise->nom_entreprise);?>"> 
		<br>
		<br> 
		...
		<label> Tuteur </label><input class="pseudo" id="pseudo" type="mail" placeholder=" email_tuteur@mail.com " name="email_tuteur" required="" value="<?php $this->load->model('mStages'); echo set_value('email_tuteur',$this->mStages->get_utilisateur_email($entreprise->tuteur));?>" > 
		<br>
			
		<center><input type="submit" id="button" value="Valider"><?php echo anchor("/main_stage/supprimer_entreprise/$entreprise->id_entreprise",'Supprimer', 'class="btn_choice" ' ); ?></center>

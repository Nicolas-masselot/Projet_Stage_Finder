...
<body id="page-top" class="index">
    ...
    <section id="about" class="bg-light-gray"> 
               ...
               <div class="row text-center"> 
                    ...
                    <h7> Sauvegarder L'annonce ? </h7>
                    <br>
                    <br>
                    
                   <div>
						<?php echo anchor("/main_stage/sauvegarder_offre/$stage->id_stage",'Oui', 'class="btn_choice" ' ); ?>
						<?php echo anchor("/main_stage/afficher_offre/$stage->id_stage",'Non ', 'class="btn_choice" ' ); ?>
					</div>                    
			</div>
